...
namespace SAS.EventsService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250616095933_AddNamedEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SAS.EventsService.Domain.Events.Entities.NamedEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SAS.EventsService.Domain.Events.Entities.NamedEntityType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SAS.EventsService.Domain.Events.Entities.NamedEntity", b =>
                {
                    ...
                    b.HasOne("SAS.EventsService.Domain.Events.Entities.NamedEntityType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("SAS.EventsService.Domain.Events.Entities.NamedEntityMention", b =>
                {
                    ...
                    b.HasOne("SAS.EventsService.Domain.Events.Entities.NamedEntity", "NamedEntity")
                        .WithMany()
